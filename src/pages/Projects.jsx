  ...
  return (
    <div>
      ...
      <div className="stat-grid" style={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
        ...
        <div className="stat-card">
          <div className="stat-card-label">In launch phase</div>
          <div className="stat-card-value" style={{ color: 'var(--info-600)' }}>{counts.launch}</div>
        </div>
        <div className="stat-card">
          <div className="stat-card-label">In ongoing phase</div>
          <div className="stat-card-value" style={{ color: 'var(--success-600)' }}>{counts.ongoing}</div>
        </div>
        <div className="stat-card">
          <div className="stat-card-label">New deal handoff</div>
          <div className="stat-card-value" style={{ color: 'var(--brand-600)', cursor: 'pointer', fontSize: '16px' }}>Create Project</div>
        </div>
      </div>
                    ...
                    <td>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        <div>
                          ...
                          {project.bilingual && (
                            <span className="badge badge-bilingual" style={{ marginTop: '2px' }}>Bilingual</span>
                          )}
                        </div>
                      </div>
                    </td>
